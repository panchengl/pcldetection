...
names_dict = {}
cnt = 0
f = open('/home/pcl/pytorch_work/my_github/retinanet/data/voc.names', 'r').readlines()
for line in f:
    line = line.strip()
    names_dict[line] = cnt
    cnt += 1

voc_07 = '/home/pcl/data/voc/VOCdevkit/VOC2007'
voc_12 = '/home/pcl/data/voc/VOCdevkit/VOC2012'
...
gen_train_txt('/home/pcl/pytorch_work/my_github/retinanet/data/train.txt')
gen_test_txt('/home/pcl/pytorch_work/my_github/retinanet/data/val.txt')
