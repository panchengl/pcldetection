...
def main():
    ...
    for epoch_num in range(start_epoch, cfg["epochs"]):
        ...
        for iter_num, data in enumerate(dataloader_train):
            ...
            # print("regression_s shape is",  regressions_s.shape)
            # print("classification_s shape is", classicifications_s.shape)
            # print("regression_t shape is", regressions_t.shape)
            # print("classification_t shape is", classicifications_t.shape)
            ...
            # soft_target, reg_ratio = knowledge_distill_loss.distillation_loss2(data, anchors, output_s, output_t, cfg)
