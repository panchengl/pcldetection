...
model_cfg = dict(
    ...
    lr = 1e-5,
    save_dir = 'checkpoint/',
    restore_path = '/home/pcl/pytorch_work/my_github/pcldetection/checkpoint/csv_retinanet_epoch_14_resnet_50_map_0.777_lr_1e-05.pt',
    epochs = 100,
    iou_threshold=0.5,
...
inference_cfg = dict(
    ...
    test_model_path = 'checkpoint/csv_retinanet_epoch_10_resnext_101_map_0.82_lr_1e-05.pt',
    conf = 0.3,
)
